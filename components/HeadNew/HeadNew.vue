<template>
  <div class="site-nav lazyloading-hidden">
    <div class="site-nav-container">
      <div class="site-nav-desktop-only align-center">
        <div data-site-nav-category="Top Nav">
          <a href="/" data-site-nav-element="Logo">
            <svg xmlns="http://www.w3.org/2000/svg" width="76px" height="80px" viewBox="0 0 76 19" fill="none" class="site-nav-desktop-logo fill-current">
        ...
        <ul class="site-nav-desktop-nav">
                ...
                <div data-site-nav-category="Inspiration">
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="Explore Design Work" href="/shots/popular">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="none" class="site-nav-dropdown-icon"><path d="M33.241 14h-2.617v5.523a4.114 4.114 0 01-4.102 4.102H7v9.617c0 .967.791 1.758 1.758 1.758H33.24c.967 0 1.758-.791 1.758-1.758V15.758c0-.967-.791-1.758-1.758-1.758z" fill="#787EFF"></path><path d="M26.25 21H1.75C.787 21 0 20.212 0 19.25V1.75C0 .787.787 0 1.75 0h24.5C27.212 0 28 .787 28 1.75v17.5c0 .962-.788 1.75-1.75 1.75z" fill="#EA4C89"></path><path d="M17.126 5.53c-1.315-.153-2.172.49-3.15 1.53-1.04-1.04-1.836-1.683-3.151-1.53-1.805.183-3.212 2.263-2.906 4.068.49 2.875 3.028 4.588 6.087 6.118 3.059-1.53 5.598-3.243 6.087-6.118.275-1.805-1.162-3.885-2.967-4.068z" fill="#fff"></path></svg>
                  ...
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="Playoffs" href="/shots?list=playoffs">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 33" fill="none" class="site-nav-dropdown-icon"><rect y=".75" width="18.375" height="14" rx="1.7" fill="#787EFF"></rect><rect width="18.375" height="14" rx="1.7" transform="matrix(-1 0 0 1 34.999 18.25)" fill="#787EFF"></rect><circle cx="28" cy="7.75" r="7" fill="#4BB7BF"></circle><circle r="7" transform="matrix(-1 0 0 1 7 25.25)" fill="#4BB7BF"></circle></svg>
                  ...
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="Weekly Warm-up" href="/shots/15846286-Design-a-character-for-a-new-video-game">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" class="site-nav-dropdown-icon"><path d="M28.761 16.207L13.461 40h15.3V16.207z" fill="#FFD469"></path><path d="M28.762 10.326h10.741V35.8A4.2 4.2 0 0135.304 40h-6.542V10.326z" fill="#FEBA57"></path><path d="M11.238.903h24.066a4.199 4.199 0 014.199 4.199v5.224H11.238V.903z" fill="#FFD469"></path><path d="M.497 5.102c0-2.32 1.88-4.2 4.2-4.2h6.542v15.962H.496V5.102z" fill="#FEBA57"></path><path d="M.497 16.864h20.406l-9.664 13.848H.496V16.864z" fill="#FFD469"></path><path d="M.497 30.712h19.14L13.776 40h-9.08a4.199 4.199 0 01-4.2-4.199v-5.09z" fill="#FEBA57"></path></svg>
                ...
                <div data-site-nav-category="Find Work">
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="Job Board" href="/jobs">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" class="site-nav-dropdown-icon"><path fill="#787EFF" d="M0 0h22v22H0z"></path><path fill="#FEBA57" d="M0 25h15v15H0z"></path><path fill="#4BB7BF" d="M25 0h15v22H25z"></path><path fill="#787EFF" d="M18 25h22v15H18z"></path></svg>
          ...
          <li class="site-nav-desktop-item" data-site-nav-category="Top Nav">
            <a data-site-nav-element="Learn" href="/learn">
              <span>Learn <span class="site-nav-medium-screens-only">Design</span></span>
            </a>    </li>
                ...
                <div data-site-nav-category="Hire Designers">
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="Designer Search" href="/designers">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" class="site-nav-dropdown-icon"><circle cx="5.338" cy="34.634" r="3.908" fill="#FEBA57"></circle><circle cx="5.338" cy="19.633" r="4.633" fill="#FEBA57"></circle><circle cx="5.338" cy="4.633" r="3.892" fill="#FEBA57"></circle><circle cx="20.338" cy="34.634" r="4.633" fill="#FEBA57"></circle><circle cx="20.339" cy="19.633" r="6.522" fill="#4D44C6"></circle><circle cx="20.339" cy="4.633" r="4.633" fill="#FEBA57"></circle><circle cx="35.339" cy="34.634" r="3.908" fill="#FEBA57"></circle><circle cx="35.339" cy="19.633" r="4.633" fill="#FEBA57"></circle><circle cx="35.339" cy="4.633" r="3.892" fill="#FEBA57"></circle></svg>
                  ...
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="List my Job Opening" href="/jobs/new">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 39 40" fill="none" class="site-nav-dropdown-icon"><path fill="#EA4C89" d="M0 .61h21.45v21.45H0z"></path><path fill="#4BB7BF" d="M0 24.985h14.625V39.61H0zM24.375.61H39v21.45H24.375z"></path><path fill="#FEBA57" d="M17.55 24.985H39V39.61H17.55z"></path><path fill="#fff" d="M5.85 12.31v-1.95h9.75v1.95z"></path><path fill="#fff" d="M11.7 16.21H9.75V6.46h1.95z"></path></svg>
                  ...
                  <li class="site-nav-dropdown-item">
                    <a class="site-nav-dropdown-item-padding site-nav-dropdown-item-hover flex" data-site-nav-element="Post a Freelance Project" href="/freelance-jobs">
                      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none" class="site-nav-dropdown-icon">
                        <path d="M14.8477 2.66302C6.05402 2.66302 1.37305 1.04476 1.37305 1.04476L1.37305 37.4074C8.84082 38.7193 12.8854 38.0318 17.0115 37.3305C19.4927 36.9087 22.0034 36.482 25.3056 36.482C34.0994 36.482 38.7803 38.1002 38.7803 38.1002L38.7803 1.73758C31.3126 0.425674 27.268 1.11317 23.1419 1.81451C20.6607 2.23626 18.15 2.66302 14.8477 2.66302Z" fill="#787EFF"></path>
                        <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="1" y="0" width="38" height="39">
                          <path d="M14.8477 2.66302C6.05402 2.66302 1.37305 1.04476 1.37305 1.04476L1.37305 37.4074C8.84082 38.7193 12.8854 38.0318 17.0115 37.3305C19.4927 36.9087 22.0034 36.482 25.3056 36.482C34.0994 36.482 38.7803 38.1002 38.7803 38.1002L38.7803 1.73758C31.3126 0.425674 27.268 1.11317 23.1419 1.81451C20.6607 2.23626 18.15 2.66302 14.8477 2.66302Z" fill="#4D44C6"></path>
                        </mask>
                        <g mask="url(#mask0)">
                          <rect x="-3.63672" y="-0.00415039" width="20.0793" height="41.4534" transform="rotate(-6.94165 -3.63672 -0.00415039)" fill="#4D44C6"></rect>
                          <rect x="3.29199" y="-3.448" width="12.6575" height="51.8273" transform="rotate(-21 3.29199 -3.448)" fill="#4D44C6"></rect>
                        </g>
                        <rect x="11" y="21.2902" width="3.43008" height="17.1504" transform="rotate(-90 11 21.2902)" fill="white"></rect>
                        <rect x="21.291" y="28.1504" width="3.43008" height="17.1504" transform="rotate(180 21.291 28.1504)" fill="white"></rect>
                      </svg>
      ...
      <ul class="site-nav-actions" data-site-nav-category="Top Nav">
        ...
        <li class="js-site-nav-sign-in site-nav-actions-item">
          <a data-site-nav-element="Sign in" href="/session/new?return_to=%2Fstories%3Fpage%3D2">Sign in</a>
        </li>
