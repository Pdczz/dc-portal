      ...
      <div class="site-nav-container">
        <div class="site-nav-desktop-only align-center">
          <div data-site-nav-category="Top Nav">
            <a href="/" data-site-nav-element="Logo">
              ...
              <img src="~static/img/warrior-shield111.e9d71b6.png" alt="">
          ...
          <ul class="site-nav-desktop-nav">
            <li class="site-nav-desktop-item site-nav-hover-item" data-site-nav-category="Top Nav">
              ...
              <!--            <a data-site-nav-element="Inspiration" href="/jotter"></a>-->

            </li>

            <li class="site-nav-desktop-item site-nav-hover-item" data-site-nav-category="Top Nav">
              <nuxt-link :to="{name:'jotter'}">博客文章</nuxt-link>
              <!--            <a data-site-nav-element="Inspiration" href="/jotter"></a>-->
        ...
        <ul class="site-nav-actions" data-site-nav-category="Top Nav">
          ...
          <!--<li class="js-site-nav-sign-up site-nav-actions-item site-nav-desktop-only">
            <a class="form-sub" data-site-nav-element="Sign Up" href="/signup/new">Sign in</a>
          </li>-->
