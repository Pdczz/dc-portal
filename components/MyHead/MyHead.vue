<template>
  ...
  -->
        ...
        <div id="logo">
          ...
          <!--          <a href="#"> <img src="~static/images/logo-light.png" class="logo-inverse" alt=""></a>-->
        </div>
        ...
        <div class="head_user">
          ...
          <div onclick="alert(loginShow)" class="btn-upgrade uk-visible@s"> <i class="uil-bolt-alt" ></i> Pro</div>
          <el-button @click="loginShow = true">打开</el-button>
          ...
          <div uk-dropdown="pos: top-right;mode:click ; animation: uk-animation-slide-bottom-small"
            ...
            <div class="dropdown-notifications-content uk-flex uk-flex-middle uk-flex-center text-center">
              ...
              <div class="uk-flex uk-flex-column choose-upload  text-center">
                <img src="~static/images/upload.png" width="70" class="m-auto" alt="">
                ...
                <div>
                  <a href="single-video.html" class="video-post video-post-list">
                    ...
                    <div class="video-post-content">
                      ...
                      <img src="~static/images/avatars/avatar-3.jpg" alt="">
                ...
                <div>
                  <a href="single-video.html" class="video-post video-post-list">
                    ...
                    <div class="video-post-thumbnail">
                      ...
                      <span class="play-btn-trigger"></span>
                      <img src="~static/images/video-thumbal/1.png" alt="">
                    </div>
                    <!-- Blog Post Content -->
                    <div class="video-post-content">
                      <h3> Learn how to create PHP singleton class </h3>
                      <img src="~static/images/avatars/avatar-2.jpg" alt="">
                ...
                <div>
                  <a href="single-video.html" class="video-post video-post-list">
                    ...
                    <div class="video-post-thumbnail">
                      ...
                      <span class="play-btn-trigger"></span>
                      <img src="~static/images/video-thumbal/3.png" alt="">
                    </div>
                    <!-- Blog Post Content -->
                    <div class="video-post-content">
                      <h3> Learn Creating Laravel Package Initializing ... </h3>
                      <img src="~static/images/avatars/avatar-5.jpg" alt="">
                ...
                <div>
                  <a href="single-video.html" class="video-post video-post-list">
                    ...
                    <div class="video-post-thumbnail">
                      ...
                      <span class="video-post-time">23:00</span>
                      <span class="play-btn-trigger"></span>
                      <img src="~static/images/video-thumbal/4.png" alt="">
                    </div>
                    <!-- Blog Post Content -->
                    <div class="video-post-content">
                      <h3> Learn how to upload files using Laravel .. </h3>
                      <img src="~static/images/avatars/avatar-4.jpg" alt="">
          ...
          <!-- profile -image -->
          <a class="opts_account"> <img src="~static/images/avatars/avatar-1.jpg" alt=""></a>
...
<style >
  ...
  .login-modal .login-container .login-content {
    text-align: center;
    display: flex;
    align-items: center;
  ...
  .login-modal .login-container .login-content .login-github,
  .login-modal .login-container .login-content .login-qq {
    width: 120px;
    padding: 10px 0;
    margin: 0 10px;
    text-align: center;
  ...
  .login-modal .login-container .login-content .login-github:hover,
  .login-modal .login-container .login-content .login-qq:hover {
    background: #f6f6f6;
    box-shadow: 0 0 5px 0 rgba(0,0,0,0.2);
    border-radius: 8px;
  }
  .login-modal .login-container .login-content .login-github:hover .title,
  .login-modal .login-container .login-content .login-qq:hover .title {
    color: #409eff;
  }
  .login-modal .login-container .login-content .login-github .title,
  .login-modal .login-container .login-content .login-qq .title {
    font-size: 1rem;
    padding: 5px 0;
  }
  .login-modal .login-container .login-content .login-qq {
  ...
  .login-modal .login-container .login-content .login-qq img {
    width: 56px;
    height: 56px;
    border-radius: 50%;
  }
  .login-modal .login-container .login-content .login-github .github-icon {
    width: 56px;
    height: 56px;
    font-size: 64px;
    display: inline-flex;
